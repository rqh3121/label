<div class="card shadow-sm">
    <div class="card-header bg-white py-3">
        <h4 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Tambah Pengiriman Baru</h4>
    </div>
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input list="city-list" name="receiver_city" class="form-control" required>
                ...
                <div class="mb-3">
                    ...
                    <input list="address-list" name="receiver_address" class="form-control" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="item_description" class="form-control" rows="2" placeholder="Isi deskripsi barang"></textarea>
                </div>
            </div>
        </div>
